 ...
 * It is used to fetch the price of all crypto currencies every 10 seconds.
 *
...
public class PriceFetchService {
     ...
     * @param jmsPriceService The JMS price service
     * @param cryptoCurrencyService The crypto currency service
     */
    @Autowired
